...
import { ClientCredentialsService, IClientCredentials } from "./clientCredentialsService"
    ...
    mockStoredClientCredentialsArray = [
      {
        ...
        "issuer": "mockIssuer",
        "salt": "0vjPs=djeEHP",
        "hashed_client_secret": "964adf477e02f0fd3fac7fdd08655d1e70ba142f02c946e21e1e194f49a05379", // mockClientSecret hashing with above salt
      },
      {
