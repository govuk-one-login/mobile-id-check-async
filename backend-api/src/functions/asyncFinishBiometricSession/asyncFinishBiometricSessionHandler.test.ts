...
describe("Async Finish Biometric Session", () => {
  ...
  describe("Session update scenarios", () => {
    describe("When session not found", () => {
      describe("and audit event write fails", () => {
        ...
        it("Logs audit event error with persistentIdentifiers and returns 500", () => {
          expect(consoleErrorSpy).toHaveBeenCalledWithLogFields({
  ...
  describe("Given sending message to vendor processing queue fails", () => {
    describe("Given sending DCMAW_ASYNC_CRI_5XXERROR event also fails", () => {
      ...
      it("Logs the send message to vendor processing queue failure with persistentIdentifiers", () => {
        expect(consoleErrorSpy).toHaveBeenCalledWithLogFields({
          messageCode:
      ...
      it("Logs the DCMAW_ASYNC_CRI_5XXERROR event failure with persistentIdentifiers", () => {
        expect(consoleErrorSpy).toHaveBeenCalledWithLogFields({
          messageCode: "MOBILE_ASYNC_ERROR_WRITING_AUDIT_EVENT",
          data: {
  ...
  describe("Given a request containing a valid sessionId is made", () => {
    ...
    describe("Given sending DCMAW_ASYNC_APP_END event fails", () => {
      ...
      it("Logs the DCMAW_ASYNC_APP_END event failure with persistentIdentifiers", () => {
        expect(consoleErrorSpy).toHaveBeenCalledWithLogFields({
          messageCode: "MOBILE_ASYNC_ERROR_WRITING_AUDIT_EVENT",
          data: {
    ...
    it("Logs COMPLETED with persistentIdentifiers", async () => {
      expect(consoleInfoSpy).toHaveBeenCalledWithLogFields({
