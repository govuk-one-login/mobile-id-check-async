...
import { GetSessionError, UpdateSessionError, } from "../common/session/SessionRegistry/types";
...
import { BiometricSession, GetBiometricSessionError, } from "./getBiometricSession/getBiometricSession";
