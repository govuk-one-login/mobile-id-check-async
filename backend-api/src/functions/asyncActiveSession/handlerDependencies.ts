...
import { ITokenService, ITokenServiceDependencies, TokenService } from "./tokenService/tokenService";
...
export interface IAsyncActiveSessionDependencies {
  ...
  tokenService: (tokenServiceDependencies: ITokenServiceDependencies) => ITokenService;
}
...
export const dependencies: IAsyncActiveSessionDependencies = {
  ...
  tokenService: (tokenServiceDependencies: ITokenServiceDependencies) => new TokenService(tokenServiceDependencies),
};
