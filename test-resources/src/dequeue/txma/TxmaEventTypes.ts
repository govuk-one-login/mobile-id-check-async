...
export type AbortTxmaEventName =
  'DCMAW_ABORT_APP'
  | 'DCMAW_ABORT_WEB'

type ErrorTxmaEventName =
  'DCMAW_CRI_4XXERROR'
  | 'DCMAW_CRI_5XXERROR'
...
export type TxmaEvent = GenericTxmaEvent | UserInteractionTxmaEvent | SessionRecoveredTxmaEvent | AppStartTxmaEvent | VcIssuedTxmaEvent
