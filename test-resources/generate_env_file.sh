...
TEST_ENVIRONMENT=$(aws cloudformation describe-stacks --stack-name "$TEST_RESOURCES_STACK_NAME" --query "Stacks[0].Parameters[?ParameterKey=='Environment'].ParameterValue" --output text)
